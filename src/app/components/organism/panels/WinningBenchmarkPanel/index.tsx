...
const OPERATORS: {
  ...
  { key: "telkomsel", label: "Telkomsel", icon: "/icons/tsel_.png" },
  { key: "indosat", label: "Indosat Ooredoo", icon: "/icons/isat_.png" },
  { key: "smartfren", label: "Smartfren", icon: "/icons/smartfren.png" },
  { key: "xl", label: "XL Axiata", icon: "/icons/xl_.png" },
];
