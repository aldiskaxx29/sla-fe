...
const PopupUpload = ({ close }: PopupUploadProps) => {
        ...
        <div className="h-full py-2">
          <div className="overflow-y-auto scrollbar-thin mb-2" style={{ minHeight: "50px", maxHeight: "65vh" }}>
            <div className="bg-white p-8 rounded-2xl shadow-2xl w-full max-w-md">
              <h2 className="text-2xl font-bold text-center text-sky-600 mb-6 font-[inherit]">
              ...
              <div
                ...
                className="cursor-pointer text-sky-700 text-xs border border-sky-700 rounded-sm w-fit mx-auto px-2 py-1 flex gap-2 font-semibold"
              >
