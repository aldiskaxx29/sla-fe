                    ...
                    <table className="w-220 border">
                        <thead>
                            <tr>
                                ...
                                <th className="py-0.5 px-2 sticky top-0 text-center border border-gray-800 bg-blue-200 text-gray-800" style={{boxShadow:'inset 0px 0.2px 0px #000,inset 0px -0.2px 0px #000'}}>RCA 2</th>
                        ...
                        <tbody>
                            {data.map((a,i)=>{
                                return(<tr key={i}>
                                    ...
                                    <td className="py-0.5 px-2 border border-gray-800 text-center">{a.rc2 || '-'}</td>
