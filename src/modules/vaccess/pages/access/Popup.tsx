import { CloseOutlined, FileExcelFilled } from "@ant-design/icons";
  ...
  return (
    <div className="fixed flex top-20 justify-center left-0 right-0 bottom-0">
      ...
      <div className="bg-white px-3 py-5 mx-auto rounded-sm border border-gray-200 relative h-fit z-2 mt-8 mb-30">
        ...
        ></CloseOutlined>
        <div className="italic text-red-700 font-bold text-md text-center">
          {title}
        </div>
        ...
        <div className="h-full py-2">
          ...
          <div
            className="overflow-y-auto scrollbar-thin mb-2"
          ...
          >
            <table className="w-220 border" id="excel">
              <thead>
                <tr>
                  <th
                    className="py-0.5 px-2 sticky top-0 text-center border border-gray-800 bg-blue-200 text-gray-800"
                    style={{
                      boxShadow:
                        "inset 0px 0.2px 0px #000,inset 0px -0.2px 0px #000",
                    }}
                  >
                    No
                  </th>
              ...
              <tbody>
                {data.map((a, i) => {
                  return (
                    <tr key={i}>
                      <td className="py-0.5 px-2 border border-gray-800 text-center">
                        {i + 1}
                      </td>
                      <td className="py-0.5 px-2 border border-gray-800 text-center">
                        {REG[a.region]}
                      ...
                      <td className="py-0.5 px-2 border border-gray-800 text-center">
                        {Number(a.pop_value).toFixed(2) ?? 0}
                      </td>
                      {mode != "lat" && mode != "jit" && (
                        <td className="py-0.5 px-2 border border-gray-800 text-center">
                          {a.status_pl}
